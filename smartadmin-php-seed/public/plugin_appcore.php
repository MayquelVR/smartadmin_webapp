...
$_title = 'App.Core - Core Plugins - SmartAdmin v4.0.2';
$_active_nav = 'plugin_appcore';
                                            ...
                                            <table class="table table-hover table-bordered m-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fs-sm">
                                                            Push array to <code>body</code> tag. See <a href="<?= APP_URL ?>/intel_saving_db.php">saving to database</a> for more details
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td class="fs-sm">
                                                            Fetch class names from <code>body</code> and convert them to JSON string. See <a href="<?= APP_URL ?>/intel_saving_db.php">saving to database</a> for more details
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
