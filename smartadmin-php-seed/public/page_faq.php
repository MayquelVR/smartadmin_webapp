...
$_title = 'FAQ - Page Views - SmartAdmin v4.0.2';
$_active_nav = 'page_faq';
$_head = '	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/.../styles.css">
';
$_description = 'Frequently Asked Questions (FAQ) page';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-plus-circle'></i> FAQ
                                <small>
