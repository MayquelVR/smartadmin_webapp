...
$_title = 'Products - App Views - SmartAdmin v4.0.2';
$_active_nav = 'page_ecommerce_products';
$_head = '	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/.../styles.css">
';
$_description = 'E-commerce products layout';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-plus-circle'></i> Products
                                <small>
                                    E-commerce products layout
                                </small>
                            </h1>
                        </div>
