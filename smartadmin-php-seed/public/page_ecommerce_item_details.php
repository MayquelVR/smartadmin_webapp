...
$_title = 'Item - App Views - SmartAdmin v4.0.2';
$_active_nav = 'page_ecommerce_item_details';
$_head = '	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/.../styles.css">
';
$_description = 'E-commerce item details';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-plus-circle'></i> Item Details
                                <small>
