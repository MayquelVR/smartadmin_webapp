...
$_title = 'Orders - App Views - SmartAdmin v4.0.2';
$_active_nav = 'page_ecommerce_orders';
$_head = '	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/.../styles.css">
';
$_description = 'E-commerce orders layout';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-plus-circle'></i> Orders
                                <small>
                                    E-commerce orders layout
                                </small>
                            </h1>
                        </div>
