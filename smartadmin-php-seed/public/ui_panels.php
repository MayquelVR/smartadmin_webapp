...
$_title = 'Panels - UI Components - SmartAdmin v4.0.2';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="alert alert-primary alert-dismissible">
                            ...
                            <br>
                            <br>
                            Give user access to create panel settings using localstorage. You can change colors, remember collapse state, lock location, and add drag functions to panels. Be sure to check out the our exclusive <a href="<?= APP_URL ?>/plugin_smartpanels.php" target="_blank">SmartPanels</a> plugin.
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
