...
$_title = 'Generate Stack - Font Icons - SmartAdmin v4.0.2';
                                    ...
                                    <div class="panel-content">
                                        <div class="row">
                                            <div class="col-12 col-xl-auto">
                                                <div class="d-flex align-items-center justify-content-center position-relative w-100 mb-g mb-xl-0" style="font-size: 250px; min-width: 301px; height: 351px; background: url(<?= ASSETS_URL ?>/img/backgrounds/bg-5.png) #fff; border-left:0; border-top:0; ">
